...
static struct msm_camera_eeprom_read_t imx134_eeprom_read_tbl[] = {
	{0x70, &imx134_wbcalib_data[0], 8, 0},// for High Color Temperature
	{0xBC, &imx134_wbcalib_data[8], 4, 0},// for High Color Temperature(4byte)
	{0x78, &imx134_wbcalib_data[12], 8, 0},// for Low Color Temperature
	{0xC0, &imx134_wbcalib_data[20], 4, 0},// for Low Color Temperature(4byte)
	{0x98, &imx134_wbcalib_data[24], 8, 0},// for Fluorescent
	{0xC4, &imx134_wbcalib_data[32], 4, 0},// for Fluorescent(4byte)
	{0xD0, &imx134_afcalib_data[0], 2, 0},//dac value for inf
	{0xD4, &imx134_afcalib_data[2], 2, 0},//dac value for macro
	{0xD8, &imx134_afcalib_data[4], 2, 0},// AutoFocus scan range
	{0x100, &imx134_lsccalib_data, 768, 0},// AutoFocus scan range
};
