...
struct pm8921_chg_chip {
    ...
    struct power_supply		simply_batt_psy;
	struct dentry			*dent;
...
static int AC_reported_exist = 0;
...
static int removed_timeout_count = 0;
